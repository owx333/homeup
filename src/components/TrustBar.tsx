...
export function TrustBar() {
  ...
  return (
    <section className="relative overflow-hidden border-y border-white/8 bg-brand py-5 md:py-7">
      <div className="marquee-slow flex items-center gap-10 whitespace-nowrap px-6 md:gap-16">
        {loop.map((item, i) => (
